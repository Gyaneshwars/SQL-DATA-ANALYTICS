...
ct.userId,ct.collectionEntityToProcessId,ct.collectionEntityTypeId,cet.collectionEntityTypeName,ct.collectionstageId,ct.issueSourceId,ct.stageInsertedDate,ct.insertedDate,ct.startDate INTO #CTAdminData 
...
WHERE           ----ct.collectionStageId IN (2,155) AND relatedcompanyid IS NOT NULL
             ct.collectionProcessId = 64 AND ct.collectionStageStatusId IN (4) ---AND ct.PriorityID IN (1,3,9,10,14,15,20,30,33,35)
---AND             ct.enddate BETWEEN @frdate AND  @todate AND ct.userId NOT IN (907321171)
AND             ct.collectionEntityId IN (-2037073030)
